...
class RegisterController extends BaseController
{
    ...
    protected function create(array $data)
    {
        return Customer::query()->create([
            ...
            'national' =>  BaseHelper::clean($data['national']),
            'birthday' =>  BaseHelper::clean($data['birthday']),
            'nationality' =>  BaseHelper::clean($data['nationality']),
             'speciality' =>  BaseHelper::clean($data['speciality']),
            'gender' =>  BaseHelper::clean($data['gender']),
