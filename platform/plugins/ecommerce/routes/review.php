...
// Route::get('test-other-api',[PaymentController::class,'testOtherApi']);
// Route::get('test-payment-callback',[PaymentController::class,'paymentCallback'])->name('pay.callback');

// Route::get('/geidea/checkout', [PaymentController::class, 'createPayment'])->name('geidea.checkout');
// Route::get('/geidea/callback', [PaymentController::class, 'handleCallback'])->name('geidea.callback');
