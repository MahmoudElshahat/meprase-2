    ...
    public function setup(): void
    {
        ...
        $this
            ...
            ->add(
                ...
                TextField::class,
                TextFieldOption::make()
                    ->label(trans('plugins/ecommerce::customer.national ID'))
            ...
            ->add(
                ...
                SelectFieldOption::make()
                    ->label(trans('plugins/ecommerce::customer.nationality'))
                    ->choices($countryChoices)
                    // ->colspan(1)
            )
            ->add(
                ...
                TextField::class,
                TextFieldOption::make()
                    ->label(trans('plugins/ecommerce::customer.speciality'))
                    ->colspan(1)
            )
            ->add(
                'gender',
                SelectField::class,
                SelectFieldOption::make()
                    ->label(trans('plugins/ecommerce::customer.gender'))
                    ->choices([
                        'male' => trans('plugins/ecommerce::customer.male'),
                        'female' => trans('plugins/ecommerce::customer.female'),
                    ])
                    ->colspan(1)
            )
            ...
            ->add(
                ...
                DatePickerFieldOption::make()
                    ->label(trans('plugins/ecommerce::customer.birthday'))
                    ->defaultValue(null)
                    ->colspan(1)
            )
            ->add(
